  ...
  useEffect(() => {
    const getPlayerInfo = async () => {
      try {
        ...
        const p1TokenData = await contract.call('getPlayerToken', [
          player01Address,
        ]);
        //console.log(p1TokenData);
        const player01 = await contract.call('getPlayer', [player01Address]);
        const player02 = await contract.call('getPlayer', [player02Address]);
